...
pdm                     :: Pdm (DEBUG false, OP_MODE 1)
ndm                     :: Ndm (DEBUG false, OP_MODE 1)

tr                      :: NewTrueRange (DEBUG false, OP_MODE 1)

ewma_pdm, ewma_ndm,
      ewma_tr, ewma_dx  :: EwmaIncremental (ALPHA_PERIODS 13, BUF_SIZE 13, DEBUG false, OP_MODE 1)

pdi                     :: Pdi (DEBUG false, OP_MODE 1)
ndi                     :: Ndi (DEBUG false, OP_MODE 1)

dx                      :: Dx (DEBUG false, OP_MODE 1)
