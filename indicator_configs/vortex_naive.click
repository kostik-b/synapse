...
vmu                     :: Vmu (DEBUG false, OP_MODE 1)
vmd                     :: Vmd (DEBUG false, OP_MODE 1)

tr                      :: NewTrueRange (DEBUG false, OP_MODE 1)

sum_vmu, sum_vmd, sum_tr:: Sum (DEBUG false, OP_MODE 1, SUM_PERIODS 13, BUF_SIZE 13)

viu                     :: Viu (DEBUG false, OP_MODE 1)
vid                     :: Vid (DEBUG false, OP_MODE 1)
