...
class Master { public:
    ...
    inline const uint64_t get_start_time_as_cycles ();
  ...
  private:
    ...
    uint64_t  _start_time_as_cycles;
...
inline const uint64_t Master::get_start_time_as_cycles ()
{
  return _start_time_as_cycles;
}
